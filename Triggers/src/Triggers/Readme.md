...
- serverless.yml - an AWS CloudFormation Serverless Application Model template file for declaring your Serverless functions and other AWS resources
...
```
    cd "Triggers/test/Triggers.Tests"
    dotnet test
```
